...
<title>ChloroSense- Add Sensor</title>
...
<script type="text/javascript">
	function validateForm() {
		...
		var x1 = document.forms["monitorForm"]["sname"].value;
	    if (x1 == null || x1 == "") {
	        alert("Please give a name for sensor");
	        return false;
	    }
	    var x2 = document.forms["monitorForm"]["desc"].value;
	    if (x2 == null || x2 == "") {
	        alert("Please give a sensor Description");
	        return false;
	    }
	    
	    var x3 = document.forms["monitorForm"]["mftr"].value;
	    if (x3 == null || x3 == "") {
	        alert("Please give the manufacturer of sensor");
	        return false;
	    }
...
<form id="monitorForm" name="monitorForm" style="margin: 120px" method="post" action="<%=request.getContextPath()%>/SensorServlet" onsubmit="return validateForm()">
<table style="border-spacing: 15px;padding:10px;">
<tr><td>Enter Sensor Name:</td><td><input type="text" id="sname" name="sname"></td></tr>
<tr><td>Enter Sensor Description:</td><td><input type="text" id="desc" name="desc"></td></tr>
<tr><td>Enter Manufacturer:</td><td><input type="text" id="mftr" name="mftr"></td></tr>
...
<span style="color:green">Sensor Added Successfully</span>
<%} %></div>
