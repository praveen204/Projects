...
<title>ChloroSense- Register Sensor</title>
...
%>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Register Sensor</h1>
...
<form id="monitorForm" name="monitorForm" style="margin: 120px" method="get" action="<%=request.getContextPath()%>/RegisterServlet" onsubmit="return validateForm()">
...
<!-- <tr><td></td><td></td></tr>-->
<tr><td colspan="2" align="center"> <input type="submit" id="register"  value="Register"></input></td></tr>
</table>
...
%>
<span style="color:green">Sensor Registered Successfully</span>
<%} else if(request.getParameter("msg").toString().equals("no")){%>
<span style="color:red">No Data available for selected criteria</span>

<%}else {%>
<span style="color:red">Registration for this criteria is already done</span>
<%}} %></div>
