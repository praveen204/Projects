...
<title>ChloroSense- Delete Sensor Hub</title>
...
%>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Delete Sensor Hub</h1>
...
<form id="monitorForm" name="monitorForm" style="margin: 120px" method="get" action="<%=request.getContextPath()%>/SensorHubServlet" onsubmit="return validateForm()">
...
<span style="color:green">Sensor Hub deleted Successfully</span>
<%} %></div>
