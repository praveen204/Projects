...
<title>ChloroSense- Sensor Monitoring</title>
...
%>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li ><a href="SensorMgmt.jsp"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg>Cloud Components</a></li>
			<li class="active"><a href="<%=request.getContextPath()%>/MenuServlet?option=analyze" ><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg>Sensor Monitoring</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Sensor Monitoring</h1>
				
			</div>
		
	<%ArrayList al=(ArrayList)session.getAttribute("hubs");
...
<option value="<%=st.getSensorType()%>"><%=st.getSensorType() %></option>
<%}} %> 
