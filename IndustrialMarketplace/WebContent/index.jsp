...
<head>
    ...
    <title>Industrial marketplace</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Industrial Marketplace</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <p>This site ensures us to know the current market trend of various industrial goods in our areas.</p>
                </div>
                <div class="col-lg-4">
                    <p>This site also provision the shopping catalog where in the products of various training institutions canbe bought </p>
                </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <form name="sentMessage" id="contactForm"   novalidate>
                        ...
                        <div class="row control-group">
                         ...
                         <div class="row control-group">
                          ...
                          <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Training Insititue</label>
                                <textarea rows="1" class="form-control" placeholder="Training Institute" id="trinst" name="trinst" required data-validation-required-message="Please enter your training institution name."></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                        </div> 
                        <div class="row control-group">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>We provide services to analyze the market trend of  goods every year and also by area <a href="https://sellfy.com/p/8Q9P/jV3VZ/"></a></p>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>We provide shopping cart of products having good market demand which are prepared by various training institutions <a href="https://sellfy.com/p/8Q9P/jV3VZ/"></a></p>
                            <ul class="list-inline item-details">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>We can monitor trend of the variety of industrial goods year by year through rich charts and graphs  <a href="https://sellfy.com/p/8Q9P/jV3VZ/"></a></p>
                            <ul class="list-inline item-details">
