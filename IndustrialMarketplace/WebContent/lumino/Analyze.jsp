...
<title>Industrial Marketplace-Analyze Market Trend</title>
...
$(document).ready(function() {
    ...
    $.ajax({
          type:'GET',
          url: durl +'/MenuServlet',
          data:'option=analyze&category='+catId+'&subcategory='+subCatId                            
        }).done(function(responseText){
          //alert("fjjsdfhk");
...
%>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="Analyze.jsp"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg>Analyze Trend</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Monitoring Market Trend</h1>
...
<tr><td>Select a Category</td><td><select id="category" name="category"><option value="">Select</option>
<%
...
<tr><td>Select Subcategory</td><td><select id="subcategory" name="subcategory" ><option value="">Select Category first</option></select></td></tr>
<!-- <tr><td></td><td></td></tr>-->
<tr><td colspan="2" align="center"> <input type="button" id="find"  value="Go"></input></td></tr>
</table>
